...
def experiment_2():
    ...
    for lethality in lethalities:
        for target in targets:
            ...
            print(
                f"Running model with superpredator target {target} and lethality {lethality}"
            )
...
def experiment_3():
    ...
    print(
        "Running experiment 3: determining the effects of predator and prey information"
    )
    ...
    for p_info in prey_info:
        for pred_info in predator_info:
            print(
                f"Running model with prey_info {p_info} and predator_info {pred_info}"
            )
...
def experiment_4():
    ...
    print(
        "Running experiment 4: effect of handling limit on apex predator and mesopredator"
    )
...
def experiment_6():
    ...
    print(
        "Running experiment 6: varying lattice size and local saturation of prey for lv model"
    )
...
def experiment_9():
    ...
    for i in range(vars.shape[0]):
        ...
        print(
            f"Running model with prey {kwargs['prey']}, predator {kwargs['predator']}, apex {kwargs['apex']}, super {kwargs['super']}"
        )
