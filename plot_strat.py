...
for strategy in strategies:
    ...
    if strategy == 'Both Naive':
        file = 'data_agents_lv_naive.csv'
        file2 = 'data_model_lv_naive.csv'
        params['prey_info'] = False
        params['predator_info'] = False
    elif strategy == 'Predator Informed':
        file = 'data_agents_lv_pred.csv'
        file2 = 'data_model_lv_pred.csv'
        params['prey_info'] = False
        params['predator_info'] = True
    elif strategy == 'Prey Informed':
        file = 'data_agents_lv_prey.csv'
        file2 = 'data_model_lv_prey.csv'
        params['prey_info'] = True
        params['predator_info'] = False
    elif strategy == 'Both Informed':
        file = 'data_agents_lv_both.csv'
        file2 = 'data_model_lv_both.csv'
        params['prey_info'] = True
        params['predator_info'] = True
