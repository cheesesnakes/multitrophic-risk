...
configs = {
    ...
    "Scenario-8": {
        "name": "Scenario-8",
        "description": "Apex predator targets both prey and mesopredator",
        "data_path": "output/experiments/results/scenario-8_results.csv",
        "status": "complete",
        "append": True,
        "n_models": 1,
        "populations": ["Prey", "Predator", "Apex"],
        ...
        "models_config": [
            {
                "description": "apex",
                "params": {"model": "apex", "apex": 500, "super": 0, "a_target": "Both"},
            },
        ],
    },
    "Test-1": {
    ...
    "Test-8": {
        ...
        "data_path": "output/experiments/results/test-8_results.csv",
        "status": "complete",
        "n_models": 1,
        "populations": ["Prey", "Predator", "Apex"],
        "variables": ["a_max"],
    ...
    "Test-9": {
        ...
        "data_path": "output/experiments/results/test-9_results.csv",
        "status": "complete",
        "n_models": 1,
        "n_params": 50,
        "populations": ["Prey", "Predator", "Apex"],
    ...
    "Test-10": {
        ...
        "data_path": "output/experiments/results/test-10_results.csv",
        "status": "complete",
        "n_models": 1,
        "n_params": 20,
        "populations": ["Prey", "Predator", "Apex"],
